...
export const DETAILED_EXERCISES = {
  push_up: {
    steps: [
      {
        step: 1,
...
export function getFallbackExerciseDetails(exerciseName = "", muscle = "") {
  const nameLower = (exerciseName || "").toLowerCase();

  // Se for qualquer variação de flexão (inclui flexão de joelhos, no chão, inclinada, flexão de braço)
  ...
  // Se for variação de agachamento
  ...
  // Fallback padrão dinâmico baseado no grupo muscular ou genérico
