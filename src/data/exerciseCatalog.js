...
export function filterByInjuries(exercises, injuries) {
...
export function filterByEquipment(exercises, availableEquipment) {
...
export function getExercisesByMuscle(muscle, level) {
  return EXERCISE_CATALOG[muscle]?.[level] || [];
}

export function getAvailableExercises({ level = 'intermediate', injuries = [], gymType = 'gym' }) {
