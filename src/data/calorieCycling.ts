...
export const CYCLING_PLANS: CyclingPlan[] = [
  {
    id: '3plus1',
    name: '3+1',
...
export const TYPE_COLORS: Record<string, string> = { high: COLORS.primary, normal: COLORS.success, low: COLORS.info };
