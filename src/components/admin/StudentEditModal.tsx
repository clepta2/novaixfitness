...
interface StudentEditModalProps {
  visible: boolean;
  student: { id: string; name?: string; email?: string; subscription_plan?: string; subscription_status?: string; current_step?: string } | null;
  onClose: () => void;
  onSave?: () => void;
}
...
export default function StudentEditModal({ visible, student, onClose, onSave }: StudentEditModalProps): React.JSX.Element {
          ...
          <TouchableWithoutFeedback>
            <View style={[styles.content, isWeb && styles.contentWeb]}>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TextInput style={styles.input} value={form.name} onChangeText={(t: string) => setForm({ ...form, name: t })} placeholder="Nome do aluno" placeholderTextColor={COLORS.textMuted} accessibilityLabel="Nome do aluno" />
