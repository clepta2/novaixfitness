...
const AUDIENCE_OPTIONS = [
  { value: 'all', label: 'Todos', icon: 'people' as const },
  { value: 'premium', label: 'Premium', icon: 'star' as const },
  { value: 'free', label: 'Free', icon: 'person' as const },
  { value: 'marketing', label: 'Marketing', icon: 'mail' as const },
];
...
export default function CampaignManager(): React.JSX.Element {
  ...
  const applyQuickMessage = (msg: typeof QUICK_MESSAGES[number]): void => {
    setTitle(msg.title);
    setBody(msg.body);
  };
