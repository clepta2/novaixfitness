...
export default memo(function IntroSlide({ icon, title, subtitle, index }: IntroSlideProps): React.JSX.Element {
  const fadeAnim = useRef<Animated.Value>(new Animated.Value(0)).current;
  const translateY = useRef<Animated.Value>(new Animated.Value(30)).current;
