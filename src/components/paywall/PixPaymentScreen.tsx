...
export default function PixPaymentScreen({ pixData, onBack, onCopyPix, onCheckPayment, loading }: PixPaymentScreenProps): React.JSX.Element {
  return (
