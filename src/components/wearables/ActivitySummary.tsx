...
export default function ActivitySummary({ steps, stepsGoal, calories, caloriesGoal, distance }: ActivitySummaryProps): React.JSX.Element {
  ...
  const metrics = [
    ...
    { icon: 'map', value: `${(distance || 0).toFixed(1)}`, label: 'km', pct: null as number | null, color: COLORS.info },
  ];
