// src/components/planner/AdaptationBanner.tsx
...
export default function AdaptationBanner({ reason, onAdapt, loading }: AdaptationBannerProps): React.JSX.Element | null {
