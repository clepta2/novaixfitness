// src/components/planner/WorkoutPicker.tsx
...
interface WorkoutPickerProps {
  ...
  onSelect: (workout: WorkoutItem | null) => void;
}

export default function WorkoutPicker({ selectedId, onSelect }: WorkoutPickerProps): React.JSX.Element {
