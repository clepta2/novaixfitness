...
function DayChip({ icon, text, borderColor }: DayChipProps): React.JSX.Element {
  return (
...
export default function DayDetailView({ dayKey, dayData, onEdit, onStart }: DayDetailViewProps): React.JSX.Element {
  return (
    <View style={styles.card}>
      ...
      <View style={styles.meta}>
        ...
        {dayData.category && (
          <DayChip
            icon={<View style={[styles.catDot, { backgroundColor: CATEGORY_COLORS[dayData.category as keyof typeof CATEGORY_COLORS] }]} />}
            text={dayData.category}
            borderColor={CATEGORY_COLORS[dayData.category as keyof typeof CATEGORY_COLORS] + '40'}
          />
        )}
      </View>
...
export function TodayCard({ dayData }: TodayCardProps): React.JSX.Element {
  return (
    <View style={styles.card}>
