// src/components/progress/BMICard.tsx
...
function getBMICategory(bmi: number): BmiCategory {
  return BMI_CATEGORIES.find((c: BmiCategory) => bmi >= c.min && bmi < c.max) || BMI_CATEGORIES[3];
}
...
export default memo(function BMICard({ bmi, height, weight }: BMICardProps): React.JSX.Element {
  const bmiValue = parseFloat(String(bmi)) || 0;
