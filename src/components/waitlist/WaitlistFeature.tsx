...
interface WaitlistFeatureProps {
  feature: WaitlistFeatureData;
  isJoined: boolean;
  onJoin: (id: string) => void;
  loading: boolean;
}

export default function WaitlistFeature({ feature, isJoined, onJoin, loading }: WaitlistFeatureProps): React.JSX.Element {
  return (
