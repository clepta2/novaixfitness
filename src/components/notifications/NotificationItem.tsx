...
const NOTIFICATION_TYPES = (APP_CONFIG as any).notifications.types;
...
export default function NotificationItem({ item, onPress, onLongPress }: NotificationItemProps): React.JSX.Element {
