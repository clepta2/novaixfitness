...
interface LocationSectionProps {
  ...
  nearTo?: string;
  setNearTo?: (nearTo: string) => void;
}

export default function LocationSection({ state, setState, city, setCity, cep, setCep, street, setStreet, neighborhood, setNeighborhood, number, setNumber, nearTo, setNearTo }: LocationSectionProps): React.JSX.Element {
  ...
  return (
    <View style={s.section}>
      ...
      <StatePickerModal visible={showStatePicker} selectedState={state || null} onSelect={setState} onClose={() => setShowStatePicker(false)} />
    </View>
  );
}
