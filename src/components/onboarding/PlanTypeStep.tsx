...
export default function PlanTypeStep({ plans, selectedPlan, onSelect }: PlanTypeStepProps): React.JSX.Element {
  return (
    <>
      ...
      <View style={styles.grid}>
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              <Ionicons name={plan.icon as any} size={32} color={active ? COLORS.primary : COLORS.textMuted} />
