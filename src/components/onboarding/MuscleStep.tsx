...
export default function MuscleStep({ muscles, selectedMuscles, onToggle }: MuscleStepProps): React.JSX.Element {
  return (
    <>
      ...
      <View style={styles.grid}>
        {muscles.map((muscle) => {
          ...
          return (
            ...
            >
              <Ionicons name={muscle.icon as any} size={24} color={active ? COLORS.primary : COLORS.textMuted} />
