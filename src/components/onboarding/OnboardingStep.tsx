...
export default function OnboardingStep({ step, data, onUpdate, onNext }: OnboardingStepProps): React.JSX.Element | null {
  const [localData, setLocalData] = useState<OnboardingData>(data || {});

  const handleUpdate = useCallback((field: string, value: any): void => {
