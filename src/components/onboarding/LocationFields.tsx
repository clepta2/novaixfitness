...
export default function LocationFields({ state, setState, city, setCity, cep, setCep, street, setStreet, neighborhood, setNeighborhood, number, setNumber, nearTo, setNearTo }: LocationFieldsProps): React.JSX.Element {
