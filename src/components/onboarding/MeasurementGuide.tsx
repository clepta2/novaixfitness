// src/components/onboarding/MeasurementGuide.tsx
...
export default function MeasurementGuide({ bodyPart }: MeasurementGuideProps): React.JSX.Element | null {
  const guide = MEASUREMENT_GUIDES[bodyPart as keyof typeof MEASUREMENT_GUIDES];
