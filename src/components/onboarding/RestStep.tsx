...
export default function RestStep({ activities, selectedActivities, onToggle }) {
  return (
    <>
      ...
      <View style={styles.grid}>
        {activities.map((activity) => {
          ...
          return (
            ...
            >
              <Ionicons name={activity.icon} size={24} color={active ? COLORS.primary : COLORS.textMuted} />
