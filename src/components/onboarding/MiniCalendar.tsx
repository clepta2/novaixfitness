// src/components/onboarding/MiniCalendar.tsx
// Calendario mini para selecao de data - NOVAIX FITNESS
...
export default function MiniCalendar({ visible, selectedDate, onSelect, onClose }: MiniCalendarProps): React.JSX.Element {
