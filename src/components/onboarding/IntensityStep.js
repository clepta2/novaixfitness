...
export default function IntensityStep({ options, selectedIntensity, onSelect }) {
  return (
    <>
      ...
      <View style={styles.grid}>
        {options.map((option) => {
          ...
          return (
            ...
            >
              <Ionicons name={option.icon} size={32} color={active ? COLORS.primary : COLORS.textMuted} />
