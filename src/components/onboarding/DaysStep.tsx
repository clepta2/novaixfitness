...
export default function DaysStep({ daysPerWeek, selectedDays, onSelect }: DaysStepProps): React.JSX.Element {
  return (
    <>
      ...
      {selectedDays && (
        <View style={styles.previewBox}>
          ...
          {WEEKLY_PLAN_TEMPLATES[`${selectedDays}_days` as keyof typeof WEEKLY_PLAN_TEMPLATES]?.template.map((day: DayTemplate, i: number) => (
