// src/components/onboarding/DraggableSlider.tsx
...
export default function DraggableSlider({ label, value, setValue, min, max, unit }: DraggableSliderProps): React.JSX.Element {
  const [editing, setEditing] = useState<boolean>(false);
  const [editText, setEditText] = useState<string>(String(value));
  const trackWidth = useRef<number>(260);
