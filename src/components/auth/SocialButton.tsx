...
function SocialButton({ icon, iconColor, label, onPress, bgColor, translucent }: SocialButtonProps): React.JSX.Element {
  ...
  return (
    ...
    >
      <View style={styles.iconContainer}>
        <FontAwesome name={icon as any} size={ICON_SIZES.md} color={iconColor} />
      </View>
