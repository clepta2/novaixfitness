...
export default function TutorialOverlay({ visible, steps, onComplete, onSkip, onRestart }) {
  ...
  const mainContent = (
    <View style={StyleSheet.absoluteFill}>
      ...
      <Animated.View style={[styles.card, spotlight ? (spotlight.cardPosition === 'top' ? styles.cardTop : styles.cardBottom) : styles.cardCenter, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
        ...
        <View style={styles.iconContainer}><Ionicons name={step.icon} size={36} color={COLORS.primary} /></View>
