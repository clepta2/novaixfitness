...
import { CommentReply, CommentLike, MentionInput } from '../exports/social';
...
function CommentSection({ comments, loading, onSubmit, commentText, onCommentTextChange }: CommentSectionProps) {
            ...
            <View key={comment.id} style={styles.item}>
              ...
              <View style={styles.content}>
                <View style={styles.authorRow}>
                  ...
                  <TouchableOpacity onPress={() => setReplyingTo(comment)} style={styles.replyBtn}>
                    <Text style={styles.replyText}>{COMMENTS.replyLabel || 'Responder'}</Text>
                  </TouchableOpacity>
                </View>
