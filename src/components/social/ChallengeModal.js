// src/components/social/ChallengeModal.js
...
const DIFF_COLORS = { 'Fácil': COLORS.success, 'Médio': COLORS.attention, 'Difícil': COLORS.error };

export default function ChallengeModal({ challenge, visible, onClose, onJoin }) {
        ...
        <Animated.View style={[styles.content, { transform: [{ translateY: slideAnim }] }]} onStartShouldSetResponder={() => true}>
          ...
          <View style={styles.header}>
            <View style={[styles.icon, { backgroundColor: color + '20' }]}>
              <Ionicons name={isComplete ? 'checkmark-circle' : icon} size={32} color={isComplete ? COLORS.success : color} />
            </View>
