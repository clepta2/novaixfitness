...
import { MoodPicker, LocationTagger } from '../exports/social';

interface CreatePostModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit?: (data: { content: string; image: string | null; mood: string | null; location: string | null }) => void;
  userId: string;
}

export default function CreatePostModal({ visible, onClose, onSubmit, userId }: CreatePostModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    onSubmit?.({ content, image: imageUrl, mood, location });
    setContent('');
    setImageUri(null);
    setMood(null);
    setLocation(null);
      ...
      <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={onClose}>
        <View style={styles.content} onStartShouldSetResponder={() => true}>
          ...
          <View style={styles.options}>
            ...
            <LocationTagger location={location} onLocationSelect={setLocation} />
          </View>
