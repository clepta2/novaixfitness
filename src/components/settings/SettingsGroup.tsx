...
function SettingsItem({ item, value, onToggle, index }: SettingsItemProps): React.JSX.Element {
...
export default function SettingsGroup({ title, items, settings, onToggle }: SettingsGroupProps): React.JSX.Element {
  return (
