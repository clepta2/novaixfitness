...
const TYPE_CONFIG: Record<ChangeType, { color: string; icon: string; label: string }> = {
...
export default function ChangelogItem({ version, date, changes }: ChangelogItemProps): React.JSX.Element {
  return (
