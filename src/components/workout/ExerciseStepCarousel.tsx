// src/components/workout/ExerciseStepCarousel.tsx
...
interface ExerciseStepCarouselProps {
  steps?: Step[];
}

function ExerciseStepCarousel({ steps }: ExerciseStepCarouselProps): React.ReactElement | null {
