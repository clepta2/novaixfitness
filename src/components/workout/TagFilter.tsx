...
interface TagFilterProps {
  ...
  onToggleTag: (category: string, tagId: string) => void;
  onClearAll: () => void;
}

export default function TagFilter({ selectedTags, onToggleTag, onClearAll }: TagFilterProps): React.ReactElement {
  const [expandedCategory, setExpandedCategory] = useState<string | null>(null);
  const activeCount = Object.values(selectedTags).flat().length;

  const toggleCategory = (catKey: string): void => {
