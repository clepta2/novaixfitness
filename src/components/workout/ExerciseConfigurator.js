// src/components/workout/ExerciseConfigurator.js
...
export default function ExerciseConfigurator({ exercise, config, onChange, onRemove }) {
  const cfg = config || { sets: 4, reps: '10-12', rest: 60, weight: '', notes: '' };
  const update = (k, v) => onChange?.({ ...cfg, [k]: v });
