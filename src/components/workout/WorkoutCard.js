...
function WorkoutCard({ workout, onPress, onFavorite, isFavorite = false, showFavorite = true, isOfflineCached = false, index = 0 }) {
        ...
        <View style={styles.cardCenter}>
          ...
          {workout.exercises && (
            <View style={styles.exerciseBar}>
              <View style={[styles.exerciseFill, { width: `${Math.min(100, (workout.exercises / 10) * 100)}%` }]} />
            </View>
          )}
        </View>
