// src/components/workout/LoadHistory.tsx
...
export default function LoadHistory({ exerciseName }: LoadHistoryProps): React.ReactElement {
  const { user } = useAuth();
...
function groupLogsByDate(logs: ExerciseLog[]): GroupedSession[] {
