// src/components/workout/WorkoutQuickStats.tsx
...
export default memo(function WorkoutQuickStats({ duration, calories, exerciseCount, totalSets }: WorkoutQuickStatsProps): React.ReactElement {
