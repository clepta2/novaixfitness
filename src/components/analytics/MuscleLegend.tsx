...
interface MuscleLegendProps {
  ...
  maxVal: number;
  minVal: number;
  getTrend: (current: number, previous: number | null) => TrendData | null;
}

export default function MuscleLegend({ values, maxVal, minVal, getTrend }: MuscleLegendProps): React.JSX.Element {
  return (
