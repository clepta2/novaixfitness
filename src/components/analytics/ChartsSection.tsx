...
function ChartCard({ title, subtitle, children, onPress, icon }: ChartCardProps): React.JSX.Element {
...
export function FrequencyChart({ data, onPress }: FrequencyChartProps): React.JSX.Element | null {
...
export function CategoryChart({ data, onPress }: CategoryChartProps): React.JSX.Element {
...
export function DayOfWeekChart({ data, onPress }: DayOfWeekChartProps): React.JSX.Element | null {
  if (!data || data.length === 0) return null;
  return (
...
export function MonthlyChart({ data, onPress }: MonthlyChartProps): React.JSX.Element | null {
...
export function HourChart({ data, onPress }: HourChartProps): React.JSX.Element | null {
  if (!data || data.length === 0) return null;
  return (
