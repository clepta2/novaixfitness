...
function DailyWorkoutCardInner({ workout, onStart, isOfflineCached = false }: DailyWorkoutCardProps): React.JSX.Element {
        ...
        >
          <View style={styles.header}>
            <View style={[styles.typeBadge, { backgroundColor: 'rgba(0,0,0,0.6)', borderColor: cardColor, borderWidth: 1 }]}>
              <Ionicons name={typeConfig.icon === 'primary' ? 'barbell' : typeConfig.icon as any} size={14} color={cardColor} />
...
const styles = StyleSheet.create({
  ...
  startBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: SPACING.sm, paddingVertical: SPACING.lg, borderRadius: BORDER_RADIUS.lg, shadowColor: COLORS.textTitle, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 5 },
