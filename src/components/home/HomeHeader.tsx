...
export default function HomeHeader({ userName, levelData, streak, onChatPress, onNotificationsPress, userAvatar }: HomeHeaderProps): React.JSX.Element {
      ...
      <View style={styles.actions}>
        {levelData && (
          <View style={[styles.levelBadge, { backgroundColor: levelData.color + '20' }]}>
            <Ionicons name={levelData.icon as any} size={14} color={levelData.color} />
