...
export default function DailyWorkoutCard({ workout, onStart }) {
  return (
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Montserrat_700Bold', fontSize: 16, color: COLORS.textTitle, textTransform: 'uppercase', lineHeight: 22, marginBottom: SPACING.lg },
