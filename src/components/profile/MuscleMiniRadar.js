...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Montserrat-Bold', fontSize: 11, color: COLORS.textMuted, letterSpacing: 1, flex: 1 },
  ...
  change: { fontFamily: 'Montserrat-SemiBold', fontSize: 9, width: 24, textAlign: 'right' },
});
