...
// Serviço LGPD - Exportar dados, Deletar conta, Consentimentos - NOVAIX FITNESS
...
export async function deleteAccount(userId) {
  ...
  if (error) {
    console.warn('Erro ao deletar do auth (pode ser Service Role necessária):', error.message);
  }
