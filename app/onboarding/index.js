...
import { ONBOARDING_STEPS, getStep, getNextStep, getProgress, getCurrentPhase } from '../../src/data/onboardingFlow';
...
export default function OnboardingScreen() {
  ...
  }, [currentStep, currentStepId, data, saveOnboarding, router]);
      ...
      {currentStep.phase && (
        <View style={styles.phaseBar}>
          ...
          <View style={[styles.phaseIndicator, currentPhase === 2 && styles.phaseActive]}>
            ...
            <Text style={[styles.phaseText, currentPhase === 2 && styles.phaseTextActive]}>Corpo</Text>
          </View>
        </View>
      )}
