...
import DataActions from '../../../src/components/settings/DataActions';
import ConsentToggles from '../../../src/components/settings/ConsentToggles';
import RightsList from '../../../src/components/settings/RightsList';
...
export default function LGPDScreen() {
  ...
  const handleDeleteAccount = () => {
    Alert.alert('Deletar Minha Conta', 'Esta ação é IRREVERSÍVEL. Tem certeza absoluta?', [
      { text: 'Cancelar', style: 'cancel' },
