...
export default function InitialPhotoScreen() {
  ...
  if (saved) {
    return (
      <ErrorBoundary screenName="InitialPhoto">
      <View style={styles.completedContainer}>
        ...
        <TouchableOpacity accessibilityLabel="Continuar" accessibilityRole="button" style={styles.button} onPress={() => router.back()}>
  ...
  return (
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.scroll}>
      ...
      <View style={styles.photoGrid}>
        {POSES.map((pose) => (
          <TouchableOpacity key={pose.id} accessibilityLabel={`Tirar foto ${pose.label}`} accessibilityRole="button" style={styles.photoCard} onPress={() => takePhoto(pose.id)}>
            {photos[pose.id] ? (
      ...
      <TouchableOpacity
        accessibilityLabel="Salvar fotos"
      ...
      <TouchableOpacity accessibilityLabel="Pular por agora" accessibilityRole="button" style={styles.skipButton} onPress={() => router.back()}>
