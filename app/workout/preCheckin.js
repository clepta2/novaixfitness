...
const SUPPORT_OPTIONS = [
  { id: 'breathing', label: 'Respiração', icon: 'leaf' },
  { id: 'small_goal', label: 'Meta pequena', icon: 'flag' },
  { id: 'progress', label: 'Ver progresso', icon: 'trending-up' },
  { id: 'music', label: 'Música', icon: 'musical-notes' },
  { id: 'rest', label: 'Descansar', icon: 'bed' },
];
...
export default function PreCheckinScreen() {
  ...
  const handleFinish = async () => {
    try {
      await saveOnboarding({ ...onboarding, preCheckin: { mood, notes, support: selectedSupport, timestamp: new Date() } });
