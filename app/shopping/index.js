    ...
    <View style={styles.screen}>
      ...
      {list && (
        <View style={styles.statsRow}>
          ...
          <TouchableOpacity style={styles.statCard} onPress={generateNewList}>
      ...
      {generating ? (
        ...
        <FlatList data={list.categories} keyExtractor={(item, i) => String(i)} contentContainerStyle={styles.list} renderItem={({ item: cat, index: catIndex }) => (
          <View style={styles.categoryCard}>
            ...
            {cat.items?.map((item, itemIndex) => (
              <TouchableOpacity key={itemIndex} style={styles.itemRow} onPress={() => toggleItem(catIndex, itemIndex)}>
        ...
        <View style={styles.emptyBox}>
          ...
          <TouchableOpacity style={styles.generateBtn} onPress={generateNewList}>
