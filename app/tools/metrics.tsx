...
export default function MetricsScreen() {
  ...
  return (
    <ErrorBoundary screenName="Metrics">
    <ScrollView style={styles.screen} contentContainerStyle={styles.scroll}>
      ...
      <View style={styles.genderRow}>
        {[{ id: 'male', label: 'Masc' }, { id: 'female', label: 'Fem' }].map(g => (
          <TouchableOpacity key={g.id} accessibilityLabel={g.label} accessibilityRole="button" style={[styles.genderBtn, gender === g.id && styles.genderActive]} onPress={() => setGender(g.id)}>
