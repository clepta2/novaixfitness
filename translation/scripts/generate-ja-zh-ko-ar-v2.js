/**
 * Script para gerar dicionários JA, ZH, KO, AR com estrutura correta
...
// Vocabulário PT com traduções para todos os idiomas
const VOCABULARY = {
  // Corpo humano
...
// Gerado automaticamente pelo script generate-ja-zh-ko-ar-v2.js
...
function main() {
  console.log('Gerando dicionários JA, ZH, KO, AR com estrutura correta...');
  ...
  // Salvar para todos os idiomas (mesmo dicionário, estrutura diferente)
  ['ja', 'zh', 'ko', 'ar'].forEach(lang => {
    saveDictionary(dictionary, lang);
  });
